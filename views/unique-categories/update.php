...
$this->title = 'Update Unique Categories: ' . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Unique Categories', 'url' => ['index']];
...
<div style="background-color: #fff; min-height: 200px; width: 80%; margin-left: auto; margin-right: auto">
    ...
    <div style="padding-left: 2%; margin-right: 2%" class="unique-categories-update">
