...
/* @var $searchModel app\models\UniqueCategoriesSearch */
...
<div style="background-color: #fff; min-height: 200px; width: 80%; margin-left: auto; margin-right: auto">
    ...
    <div style="padding-left: 2%; margin-right: 2%" class="unique-categories-index">

        <h1><?= Html::encode($this->title) ?></h1>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

        <p>
            <?= Html::a('Create Unique Categories', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
