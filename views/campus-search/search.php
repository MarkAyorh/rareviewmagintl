...
<div div style="background-color: #fff; min-height: 300px; width: 80%; margin-left: auto; margin-right: auto">
    <h3 style="padding-left: 2%; margin-bottom: 3%">
        Searching Past Campus Jists for: <span style="color: #C00"><i><?= $searched ?></i></span> Completed.
    </h3>
        ...
        <div class="searchTable"> 
                ...
                <div class="searchTableDetail1">
                    <a href="<?= Yii::$app->request->baseUrl ?>/campus/read-more?read=<?= Html::encode($item->id) ?>">
                        <img style="height: 6em; width: 6em" alt="Picture" src="<?= Yii::$app->request->baseUrl ?>/images/campus/<?= Html::encode($item->picture) ?>.jpg">        
                    </a>                 
                </div>

                <div class="searchTableDetail2">
                    <a href="<?= Yii::$app->request->baseUrl ?>/campus/read-more?read=<?= Html::encode($item->id) ?>" style="color: #C00">                    
